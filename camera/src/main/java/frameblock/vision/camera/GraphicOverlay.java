...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public static abstract class Graphic {
        ...
        /**
         * Adjusts a horizontal value of the supplied value from the view scale to the preview
         * scale.
         */
        ...
        /**
         * Adjusts a vertical value of the supplied value from the view scale to the preview scale.
         */
        ...
        /**
         * Adjusts the x coordinate from the view's coordinate system to the preview coordinate
         * system.
         */
        public float translateUpX(float x) {
            if (mOverlay.mFacing == CameraSource.CAMERA_FACING_FRONT) {
                return mOverlay.getWidth() + scaleUpX(x);
            } else {
                return scaleUpX(x);
            }
        }
        ...
        /**
         * Adjusts the y coordinate from the view's coordinate system to the preview coordinate
         * system.
         */

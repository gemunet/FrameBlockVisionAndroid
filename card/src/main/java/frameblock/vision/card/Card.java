...
/**
 * Card, representa una tarjeta encontrada en una imagen
 */
public class Card {
    /**
    ...
    public Card(Point[] cornerPoints, Rect boundingBox, float verticalDiff, float horizontalDiff, float aspectRatio) {
